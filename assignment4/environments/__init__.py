...
from .windy_lake import *

__all__ = ['RewardingFrozenLakeEnv', 
            #'WindyCliffWalkingEnv', 
            'WindyFrozenLakeEnv']
...
register(
    id='WindyFrozenLake20x20-v0',
    entry_point='environments:WindyFrozenLakeEnv',
...
def get_windy_frozen_lake_environment():
    return gym.make('WindyFrozenLake20x20-v0')
